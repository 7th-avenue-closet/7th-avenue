...
class ProductController(
    ...
    @PostMapping
    fun createProduct(@RequestBody request: CreateProductRequestDto) : ResponseEntity<ProductResponseDto>{
    ...
    fun updateProduct(
        ...
        @RequestBody request: UpdateProductRequestDto) :ResponseEntity<ProductResponseDto>{
